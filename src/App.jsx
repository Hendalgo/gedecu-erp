      ...
      <Routes>
        ...
        >
          <Route path={`/${DASHBOARD_ROUTE}`} element={<Dashboard />}>
            <Route
              index
              element={<Navigate to={`${DASHBOARD_INDEX_ROUTE}`} />}
            />
            ...
            <Route path={`${REPORTS_ROUTE}`} element={<Reports />}>
              ...
              <Route
                path={`${REPORTS_DUPLICATE_ROUTE}`}
                element={<DuplicateReports />}
              />
              <Route
                path={`${REPORTS_DUPLICATE_ROUTE}/:id`}
                element={<DuplicateReportForm />}
              />
              <Route
                path={`${REPORTS_MISS_ROUTE}`}
                element={<Inconsistences />}
              />
            </Route>
            <Route path={`${STORES_ROUTE}`}>
              ...
              <Route
                path={`:storeId/${BANK_ACCOUNTS_ROUTE}`}

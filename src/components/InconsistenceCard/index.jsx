    ...
    <Card className="mb-3 InconsistenceCard">
      <Card.Body>
        <Card.Title className="mb-2 mt-2 d-flex justify-content-between">
          <div className="d-flex flex-column">
            ...
            {report.store && (
              <span className="mb-2 text-muted" style={{ fontSize: 12 }}>
                Local: {report.store.name}
              </span>
            )}
      ...
      <Card.Footer className="bg-white">
        <Card.Text className="d-flex justify-content-between align-items-center">
          ...
          <span className="fw-medium fs-4 d-flex">
            {report.bank_account.bank.currency.symbol}{" "}
            {report.amount.toLocaleString("de-DE", { minimunfractions: 2 })}
          </span>

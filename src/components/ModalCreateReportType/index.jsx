  ...
  return (
    <Modal show={modalShow} size='lg' onHide={() => setModalShow(false)}>
          ...
          <div className='container'>
            <div className='row'>
              <div className='d-flex flex-column'>
                <span className='ModalTopTitle'>Crear nuevo tipo de reporte</span>
                <span className='ModalTopSubTitle'>Esta pestaña le permite crear un nuevo tipo de reporte</span>
              </div>
            </div>
          </div>
        </Modal.Title>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col">
                ...
                <textarea defaultValue="" name="description" id="" className='form-control' ></textarea>
              </div>
            </div>
          </div>
        </form>
      ...
      <Modal.Footer>
        ...
        <button onClick={handleBankAccount} className='btn btn-primary'>Crear tipo</button>
      </Modal.Footer>
    </Modal>
  )
}

    ...
    try {
      ...
      switch (response.status) {
        case 200:
          ...
          break;
        case 401:
          setErrorMessage('Email o contraseña incorrectos. Verifique e intente de nuevo.');
          break;
        case 422:
              ...
              <div className="bg-white LoginFormContainer">
                ...
                <form  ref={loginForm}onSubmit={handleSubmit} action="">
                  <div className="mb-3">  
                    ...
                    <input type="email" autoComplete='true' name='email' typeof='email' className='form-control' placeholder='Tu correo'/>
                  </div>
                  <div className="mb-3">
                    <label className='form-label' htmlFor="password">Contraseña *</label>
                    <div className='PasswordContainer'>
                      <input  className='form-control' name='password' type={inputPassType} placeholder='*********'/>
                      
                      <div className='ViewPassword'>
                        <label htmlFor="view-pass">
                          Mostrar/Ocultar
                        </label>
                        <input name='view-pass' type='checkbox' onClick={(e)=> inputPassType==='password'?setInputPassType('text'):setInputPassType('password') } />
                      </div>
                    </div>
                  </div>
                  <div className="mb-3">
                    {
                      errorMessage?
                      <Alert variant='danger' style={{maxWidth:'100%', textAlign: 'center'}}>
                        {errorMessage}
                      </Alert>
                      :null
                    }

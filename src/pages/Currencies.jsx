    ...
    <div className="container-fluid">
            ...
            <div className="row mt-4">
              <div className="col-12">
                <div className="d-flex justify-content-between">
                  ...
                  <PaginationTable
                    text="monedas"
                    quantity={currencies.last_page}
                    itemsTotal={currencies.total}
      ...
      <div className="">
        ...
        <ModalConfirmation
          ...
          warning="Si elimina la moneda, se eliminarán otros recursos (cuentas bancarias) asociados al mismo. ¿Desea continuar?"
          action={() => handleDelete(currency)}
        />
      </div>
    </div>
  );
